...
If the component accepts props, add fields to the struct and pass them as attributes on the custom element tag. Read them inside `connectedCallback` via `this.getAttribute(...)`:
