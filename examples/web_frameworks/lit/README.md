...
If the component accepts props, add fields to the struct and pass them as attributes. LitElement maps kebab-case attributes to camelCase properties automatically when `attribute` is set in the property descriptor:
