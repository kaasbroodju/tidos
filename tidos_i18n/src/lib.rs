...
// 					&[internal_18n_hoist!()], // This needs to be detemined once upon request of a page
...
macro_rules! enable_i18n {
	() => {
		use tidos::TidosI18nConfig;
		lazy_static::lazy_static! {
			static ref TIDOS_I18N_CONFIGURATION: TidosI18nConfig = {
				TidosI18nConfig::figment()
					.extract()
					.unwrap()
			};
		}
